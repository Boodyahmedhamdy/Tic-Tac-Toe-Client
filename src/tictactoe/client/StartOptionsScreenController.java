    ...
    private Button prevRecordsBtn;
        ...
        public boolean connectToServer(String serverIP) {
            ...
            connecting.getDialogPane().getStylesheets().add(getClass().getResource("ui/styles/enhanced-tictactoe-styles.css").toExternalForm());
        ...
        private void applyStyles(TextInputDialog ipPicker, Alert alert) {
            ipPicker.getDialogPane().getStylesheets().add(getClass().getResource("ui/styles/enhanced-tictactoe-styles.css").toExternalForm());
            alert.getDialogPane().getStylesheets().add(getClass().getResource("ui/styles/enhanced-tictactoe-styles.css").toExternalForm());
        }
